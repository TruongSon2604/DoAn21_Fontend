...
function SignIn() {
  ...
  const handleLogin = async (e) => {
    ...
    const { success, data, message } = await apiPost(
      "/auth/login",
      requestBody,
      {
    ...
    if (data.user.role == 1 && success) {
      ...
      // MySwal.fire({
      //   icon: "success",
      //   text: "Đăng nhập thành công admin! ",
      // });
      navigate("/admin");
    } else if (data.user.role != 1 && success) {
      const expiresAt = Date.now() + 60 * 60 * 1000;
    ...
    <div className="auth">
      ...
      <div className="auth__content">
        <div className="auth__content-inner">
          ...
          {errorMessage && (
            <div className="messagelogin messagelogin-success">
