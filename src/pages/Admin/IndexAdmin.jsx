...
export const IndexAdmin = () => {
  ...
  const stats = [
    {
      icon: <FaShoppingCart className="icon" size={30} />,
      label: "Đơn hàng",
      value: 120,
    },
    {
      icon: <FaDollarSign className="icon" size={30} />,
      label: "Doanh thu",
      value: "$45,000",
    },
    {
      icon: <FaBox className="icon" size={30} />,
      label: "Sản phẩm",
      value: 320,
    },
    {
      icon: <FaUsers className="icon" size={30} />,
      label: "Người dùng",
      value: 850,
    },
  ];
